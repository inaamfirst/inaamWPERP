...
type SyncRun = { id: string; status: string; sync_mode: string; attempts: number; error: string | null; created_at: string; completed_at: string | null };
